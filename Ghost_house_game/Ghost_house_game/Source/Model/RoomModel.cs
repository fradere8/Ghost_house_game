...
namespace Room
{
    public class RoomModel
    {
        ...
        public RoomModel()
        {
            ...
            Walls.Add(new Rectangle(1280, 0, 0, 720)); // правая стена
            ...
            Objects.Add(new RoomObject("Дверь", new Rectangle(950, 400, 100, 170), Color.DarkCyan)); // дверь
            ...
            Objects.Add(new RoomObject("Сундук", new Rectangle(840, 110, 50, 40), Color.Gold)); // сундук
        }
